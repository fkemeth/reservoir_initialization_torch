...
initial_test_chunk = dataset_test.x[
    idx, config["DATA"]["max_warmup"] - config["DATA"]["gh_lenght_chunks"] : config["DATA"]["max_warmup"]
]
...
ax.plot(
    dataset_test.tt[config["DATA"]["max_warmup"] - config["DATA"]["gh_lenght_chunks"] :],
    trajectory_w_warmup,
...
ax4.plot(
    ...
    dataset_test.x[idx, : config["DATA"]["max_warmup"]],
    "-x",
    markersize=3,
    label="Driven",
    color="green",
...
ax5.plot(
    dataset_test.tt[config["DATA"]["max_warmup"] - config["DATA"]["gh_lenght_chunks"] : config["DATA"]["max_warmup"]],
    trajectory_w_warmup[: config["DATA"]["gh_lenght_chunks"]],
    "-x",
    markersize=3,
    label="Driven",
    color="green",
